export default {
  ...
  subscriptions: {
    ...
    form: {
      ...
      notificationPlansTitle: 'Independent notification plans',
      notificationPlansHint: 'One subscription can have multiple independent cycles, such as monthly payment reminders and quarterly cost-sharing reminders.',
      addNotificationPlan: 'Add plan',
      notificationPlanNumber: 'Notification plan {number}',
      notificationPlanName: 'Plan name',
      notificationPlanNamePlaceholder: 'For example: Monthly payment / Cost sharing',
      notificationPlanNextDate: 'Next notification date',
      notificationPlanInterval: 'Repeat interval',
      notificationPlanTime: 'Notification time',
      notificationPlanEnabled: 'Enabled',
      notificationPlanAutoAdvance: 'Advance after sending',
      notificationPlanTitleTemplate: 'Notification title template',
      notificationPlanTitlePlaceholder: 'For example: {{plan.name}}: {{subscription.name}}',
      notificationPlanBodyTemplate: 'Notification body template',
      notificationPlanBodyPlaceholder: 'Variables: {{subscription.name}}, {{plan.name}}, {{plan.amountWithCurrency}}, {{plan.nextDate}}, {{plan.notes}}',
      notificationPlanNotesPlaceholder: 'Plan notes (optional)',
      notificationPlanVariables: 'Variables: {{subscription.name}} {{subscription.amountWithCurrency}} {{plan.name}} {{plan.amountWithCurrency}} {{plan.nextDate}} {{plan.intervalCount}} {{plan.intervalUnit}} {{plan.notes}}',
      notificationPlansEmpty: 'No independent notification plans yet',
      notificationPlanInvalid: 'Complete each plan name and date, and use HH:MM for the notification time',
      logo: {
...
- If the original summary is limited, return 1 to 2 natural sentences directly.`
  ...
  scheduler: {
    ...
    logs: {
      ...
      notificationPlanScan: '[cron] independent notification plans scanned: candidates {processedCount}, matched {matchedPlanCount}, notified {notificationCount}, successful channels {successful}',
